...
- **Target platform**: Use `AskUserQuestion` — "What platforms are you targeting for this game?"
  ...
  Note platform implications if relevant (e.g., mobile means Unity is strongly preferred; AAA 3D means Unreal is a fit).

- **Engine experience**: Use `AskUserQuestion` — "Do you already have an engine you work in?"
  Options: `Unity` / `Unreal Engine 5` / `No preference — help me decide`
