...
- `subagent_type: [UI engine specialist]` — Engine-specific UI pattern validation (e.g., unity-ui-specialist, ue-umg-specialist)
...
- Which engine UI framework should be used for this screen? (e.g., UI Toolkit vs UGUI in Unity, UMG vs CommonUI in Unreal)
