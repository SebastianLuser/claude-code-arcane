...
> See [references/experiments.md](references/experiments.md) for feature lock, usage limit, and trial expiration paywall templates with copy examples.
...
> See [references/experiments.md](references/experiments.md) for A/B testing ideas, metrics to track, dark patterns to avoid, and conversion killers.
