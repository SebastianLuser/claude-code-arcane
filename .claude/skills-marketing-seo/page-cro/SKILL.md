...
### 5-7. Trust, Objections & Friction

> See [references/experiments.md](references/experiments.md) for trust signal types and placement, objection handling patterns, and friction point checklist.
...
## Page-Specific Frameworks & Experiments

> See [references/experiments.md](references/experiments.md) for homepage, landing page, pricing page, feature page, and blog post CRO frameworks, plus experiment ideas by page type.
