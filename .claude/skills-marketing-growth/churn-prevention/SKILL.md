...
- Clear summary of what happens (access, data, billing). Explicit "Yes, cancel my account" button. No pre-checked boxes.

**Stage 5 — Post-Cancel**
- Immediate confirmation email (cancellation date, data retention, reactivation link)
- 7-day re-engagement email (single CTA, reactivation link) + 30-day win-back if warranted

---

## Exit Survey & Save Offers

> See [references/exit-survey-and-save-offers.md](references/exit-survey-and-save-offers.md) for the 7 reason categories, save offer mapping table, offer presentation rules, and timing guidance.

See also [references/cancel-flow-playbook.md](references/cancel-flow-playbook.md) for full decision trees and flow templates.
