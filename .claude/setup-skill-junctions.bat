...
for %%S in (skills-git skills-testing skills-docs skills-frontend skills-mobile skills-backend skills-devops skills-agile skills-design skills-gamedev skills-integrations skills-release skills-security) do (
  if exist "%BASE%%%S" (
    echo [%%S]
