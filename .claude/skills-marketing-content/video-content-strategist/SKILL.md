...
> See [references/scripts-and-anti-patterns.md](references/scripts-and-anti-patterns.md) for long-form YouTube script structure (hook, context, body, CTA), short-form 60-second script structure, and short-form principles.
...
> See [references/scripts-and-anti-patterns.md](references/scripts-and-anti-patterns.md) for the 6 common anti-patterns (broad keywords, inconsistent schedule, blind repurposing, missing hooks, multi-idea shorts, undefined ICP).
