...
> See [references/writing-style-rules.md](references/writing-style-rules.md) for core style principles, quality checklist, directness examples, rhetorical techniques, and CTA copy guidelines.
...
Apply the right framework per page type: Homepage (broad value prop, multiple audience paths), Landing Page (single message, single CTA, match headline to traffic source), Pricing Page (help choose the right plan, address anxiety), Feature Page (feature to benefit to outcome), About Page (story of why you exist + CTA).

**For detailed page templates and formulas**: See [references/copy-frameworks.md](references/copy-frameworks.md)
