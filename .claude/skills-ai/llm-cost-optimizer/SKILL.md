...
Expert in LLM cost engineering for reducing AI API spend at scale. Cut costs by 40-80% without degrading user-facing quality -- using model routing, caching, prompt compression, and observability to make every token count.
