...
> **350 skills, 87 agents, 15 hooks and 21 rules for Claude Code — selective deploy by profile.**
...
| `+second-brain` | Second brain en Obsidian — captura sin fricción, reviews diario/semanal/mensual, notas atómicas y hub files (PARA + Zettelkasten), captura web, auditoría de salud del vault, sintaxis nativa (markdown, Bases, Canvas) | 13 | — |
...
├── skills/                    # 346 skills (flat, one dir per skill)
