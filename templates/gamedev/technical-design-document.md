...
| Field | Value |
|-------|-------|
| **Engine** | [e.g. Unity 6 / Unreal Engine 5.4] |
| **APIs Depended On** | [Specific classes/methods used, version-pinned — e.g. `CharacterController.Move() (Unity 6.x)`] |
| **References Consulted** | [engine-reference docs read before writing this — e.g. `docs/engine-reference/unity/modules/physics.md`] |
