---
name: ue-state-trees
description: "State Tree, state machines, StateTreeTask, StateTreeCondition, StateTreeEvaluator"
category: "gamedev"
argument-hint: "[state tree o behavior]"
user-invocable: true
...
Ask before writing: this skill edits StateTree assets, tasks, conditions and evaluators. Propose the change and get approval before using Write or Edit.
...
- [ ] Tasks are single-purpose and reusable across states
- [ ] Transitions are driven by conditions and events, not by side effects in tasks
- [ ] The schema chosen matches the owner type of the tree
...
- `/ue-mass-entity` — evaluate Mass if the same behavior runs at scale
