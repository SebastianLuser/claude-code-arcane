---
name: frontend-dev
description: "Frontend development: premium UI design, cinematic animations (Framer Motion, GSAP), generative art (Three.js, p5.js), copywriting AIDA, React/Next.js + Tailwind."
category: "frontend"
...
> **Note:** Asset generation scripts require MiniMax API key. The rest of this skill works without any API key.
