...
description: "Collision detection, traces, physics simulation, physical interactions, Chaos physics"
category: "gamedev"
argument-hint: "[interaction o collision setup]"
user-invocable: true
...
Ask before writing: this skill edits collision presets, physics assets and trace code. Propose the change and get approval before using Write or Edit.

---

## Step 1: Read Project Context

Read `docs/unreal/project-context.md` to confirm:
...
- [ ] Collision channels and presets are defined in config, not hardcoded per actor
- [ ] Traces use the narrowest channel and shape that answers the question
- [ ] Complex collision is avoided on anything queried frequently
...
- `/perf-profile` — check physics and trace cost in the profiler
