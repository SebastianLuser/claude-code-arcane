...
description: "CharacterMovementComponent, movement modes, root motion, network prediction"
category: "gamedev"
argument-hint: "[movement mode o feature]"
user-invocable: true
...
Ask before writing: this skill edits CharacterMovementComponent subclasses and movement code. Propose the change and get approval before using Write or Edit.

## Context Check

Read `docs/unreal/project-context.md` to determine:
...
- [ ] Custom movement is implemented through the CMC, not by setting locations directly
- [ ] Network prediction data was extended correctly for any new movement state
- [ ] Root motion sources are used for authored displacement
...
- `/ue-networking-replication` — validate prediction and correction
