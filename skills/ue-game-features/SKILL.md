...
description: "Game Feature plugins, modular gameplay, GameFeatureAction, GameFrameworkComponentManager"
category: "gamedev"
argument-hint: "[plugin o experience]"
user-invocable: true
...
Ask before writing: this skill edits Game Feature plugin definitions and actions. Propose the change and get approval before using Write or Edit.

## Context Check

Read `docs/unreal/project-context.md` before proceeding. Determine:
...
- [ ] The feature plugin has no hard dependency back on the base game module
- [ ] Actions register and unregister symmetrically on activate/deactivate
- [ ] The feature can be disabled without breaking a packaged build
...
- `/ue-module-build-system` — verify plugin and module wiring
