...
description: "Project context document — modules, target platforms, conventions, team standards"
category: "gamedev"
argument-hint: "[new | update | section]"
user-invocable: true
...
Ask before writing: this skill edits `docs/unreal/project-context.md`. Propose the change and get approval before using Write or Edit.

The document is stored at `docs/unreal/project-context.md`.

A skeleton with every section below already laid out ships as a template at
`.claude/skills/_templates/unreal-project-context.md`. Start from it rather than from a blank
file — it installs with any profile that carries gamedev rules.
...
First, check if `docs/unreal/project-context.md` already exists.
...
After gathering information, create `docs/unreal/project-context.md` with this structure:
...
- Save to `docs/unreal/project-context.md`
...
- [ ] Engine version, modules and enabled plugins match the actual `.uproject`
- [ ] Coding conventions reflect what the codebase really does, not aspirations
- [ ] Every other `ue-*` skill can answer its Context Check from this document
