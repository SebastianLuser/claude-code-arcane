...
description: "Save/load systems, player progress persistence, data serialization, FArchive"
category: "gamedev"
argument-hint: "[save system o data]"
user-invocable: true
...
Ask before writing: this skill edits SaveGame classes and serialization code. Propose the change and get approval before using Write or Edit.

---

## Step 1: Read Project Context

Read `docs/unreal/project-context.md` before giving any recommendations. You need:
...
- [ ] Saves carry a version number and have a defined upgrade path
- [ ] Saving is asynchronous and cannot corrupt an existing file on failure
- [ ] Only owned state is serialized — no raw object pointers to transient actors
...
- `/ue-testing-debugging` — test load of an older save version
