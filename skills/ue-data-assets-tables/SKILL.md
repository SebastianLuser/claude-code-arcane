...
description: "DataAsset, DataTable, soft references, TSoftObjectPtr, async loading, Asset Manager"
category: "gamedev"
argument-hint: "[data type o asset]"
user-invocable: true
...
Ask before writing: this skill edits DataAsset and DataTable definitions plus loading code. Propose the change and get approval before using Write or Edit.

---

## Context

Read `docs/unreal/project-context.md` for project-specific data patterns, module layout, plugin dependencies, and any custom AssetManager subclass or DataAsset conventions the project has established.
...
- `references/asset-loading-patterns.md` — sync vs async load, StreamableManager and Asset Manager patterns
- `references/data-driven-design.md` — choosing DataAsset vs DataTable vs config, and how to structure game data
...
- [ ] Heavy assets are referenced softly and loaded through the Asset Manager
- [ ] Primary Asset types are registered so scanning and cooking behave correctly
- [ ] No synchronous load of large assets on the game thread during gameplay
...
- `/asset-audit` — check naming, size and orphaned assets
