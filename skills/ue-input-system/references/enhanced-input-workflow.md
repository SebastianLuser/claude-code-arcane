# Enhanced Input — Editor-Side Workflow

> Adapted from the `unreal-enhanced-input` skill in [awesome-gamedev-agent-skills](https://github.com/gamedev-skills/awesome-gamedev-agent-skills) (Apache-2.0). Cross-skill references were remapped to Arcane slash commands.
...
- `/ue-cpp-foundations` — the Character/Pawn class and module setup.
