...
Translate business goals into org requirements, headcount plan, and budget impact. Every hire needs a business case. See `references/people_strategy.md`.

### 2. Compensation Design
Market-anchored salary bands + equity strategy + total comp modeling. See `references/comp_frameworks.md`.

### 3. Org Design
Right structure for the stage. Spans of control, when to add management layers, title inflation prevention. See `references/org_design.md`.

### 4. Retention & Performance
Structured onboarding, 30/60/90 plans, regular 1:1s, career pathing, proactive comp reviews. See `references/people_strategy.md`.
