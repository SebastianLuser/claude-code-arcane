...
description: "Actor and component design — BeginPlay, Tick, component attachment, ownership, child actors"
category: "gamedev"
argument-hint: "[actor o component]"
user-invocable: true
...
Ask before writing: this skill edits actor and component classes under `Source/`. Propose the change and get approval before using Write or Edit.

## Project Context

Before responding, read `docs/unreal/project-context.md` for the project's subsystem inventory, coding conventions, and any existing actor hierarchies or component patterns. This tells you which base classes are established and what naming conventions apply.
...
- [ ] Tick is disabled unless genuinely needed; timers or events used instead
- [ ] Ownership and attachment are explicit, with no dangling component references
- [ ] Initialization happens in the correct lifecycle stage, not all in `BeginPlay`
...
- `/ue-gameplay-framework` — wire the actors into the framework classes
