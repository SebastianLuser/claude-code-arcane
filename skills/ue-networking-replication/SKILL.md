...
description: "Multiplayer networking, replication, RPCs, net roles, server/client authority"
category: "gamedev"
argument-hint: "[system o property]"
user-invocable: true
...
Ask before writing: this skill edits replicated properties, RPCs and net serialization code. Propose the change and get approval before using Write or Edit.

## Context Check

Read `docs/unreal/project-context.md` for this project's multiplayer configuration.
...
- [ ] Every replicated property appears in `GetLifetimeReplicatedProps`
- [ ] Server RPCs validate all client input; nothing trusts the client
- [ ] Replication conditions and update frequency were set per property, not left default
...
- `/ue-testing-debugging` — test with multiple clients and simulated latency
- `/security-audit` — review the client-to-server trust boundary
