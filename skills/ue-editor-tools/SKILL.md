...
description: "Editor utility widgets, Blutility, detail customization, property editors, editor subsystems"
category: "gamedev"
argument-hint: "[tool o customization]"
user-invocable: true
...
Ask before writing: this skill edits editor module code, utility widgets and detail customizations. Propose the change and get approval before using Write or Edit.

## Context

Read `docs/unreal/project-context.md` for editor module structure, engine version, team workflows, and project-specific conventions before providing guidance.
...
- [ ] Editor-only code lives in an editor module and is excluded from runtime targets
- [ ] The tool fails safely on unexpected asset state instead of corrupting data
- [ ] Bulk operations are undoable or clearly warn before running
...
- `/ue-module-build-system` — confirm the editor module is wired correctly
