# Niagara VFX — Editor-Side Workflow

> Adapted from the `unreal-niagara` skill in [awesome-gamedev-agent-skills](https://github.com/gamedev-skills/awesome-gamedev-agent-skills) (Apache-2.0). Cross-skill references were remapped to Arcane slash commands.
...
- `/ue-cpp-foundations` — spawning effects from gameplay code and module setup.
- `/ue-blueprints` — triggering effects from visual scripts.
