...
description: "AnimInstance, montages, blend spaces, state machines, anim notifies, linked anim graphs"
category: "gamedev"
argument-hint: "[character o anim feature]"
user-invocable: true
...
Ask before writing: this skill edits AnimInstance classes and animation blueprints. Propose the change and get approval before using Write or Edit.

## Context Check

Read `docs/unreal/project-context.md` first. Note which plugins are enabled
...
- [ ] Thread-safe update is used for animation evaluation where possible
- [ ] Montage sections and notifies are named consistently and documented
- [ ] No gameplay decisions are made inside the animation graph
...
- `/ue-character-movement` — align animation with the movement model
