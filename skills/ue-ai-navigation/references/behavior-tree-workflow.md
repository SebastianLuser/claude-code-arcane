# Behavior Trees — Editor-Side Workflow

> Adapted from the `unreal-behavior-trees` skill in [awesome-gamedev-agent-skills](https://github.com/gamedev-skills/awesome-gamedev-agent-skills) (Apache-2.0). Cross-skill references were remapped to Arcane slash commands.
...
- `/ue-cpp-foundations` — the AIController and pawn classes in C++.
