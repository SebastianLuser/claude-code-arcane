---
name: ue-mass-entity
description: "Mass Entity framework, MassProcessor, MassFragment, MassTag, MassObserver (UE 5.5+)"
category: "gamedev"
argument-hint: "[system o entity type]"
user-invocable: true
...
Ask before writing: this skill edits Mass processors, fragments, traits and configuration. Propose the change and get approval before using Write or Edit.
...
- [ ] Fragments hold plain data only, with logic confined to processors
- [ ] Processor execution order and dependencies are declared explicitly
- [ ] Mass is justified by entity count; a plain actor would not do
...
- `/perf-profile` — verify Mass is actually paying for itself
