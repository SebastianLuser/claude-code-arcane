...
description: "Materials, shaders, dynamic material instances, post-process, render targets, Nanite, Lumen"
category: "gamedev"
argument-hint: "[material o effect]"
user-invocable: true
...
Ask before writing: this skill edits material assets, material functions and rendering code. Propose the change and get approval before using Write or Edit.

---

## Step 1: Read Project Context

Read `docs/unreal/project-context.md` before giving advice. From it, extract:
...
- `references/material-parameter-reference.md` — material parameter types and their C++/Blueprint setters
...
- [ ] Material instances are used for variation instead of duplicated materials
- [ ] Instruction count and texture samplers stay within the platform budget
- [ ] Dynamic material instances are created once and cached, not per frame
...
- `/perf-profile` — measure the GPU cost of the change
