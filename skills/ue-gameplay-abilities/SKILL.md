...
description: "GAS, Gameplay Abilities, Gameplay Effects, Attribute Sets, Gameplay Tags, Gameplay Cues"
category: "gamedev"
argument-hint: "[ability, effect o attribute]"
user-invocable: true
...
Ask before writing: this skill edits ability, effect and attribute set classes. Propose the change and get approval before using Write or Edit.

## Context Check

Before proceeding, read `docs/unreal/project-context.md` to determine:
...
- [ ] Stats are modified through Gameplay Effects, never written directly
- [ ] State is identified by Gameplay Tags rather than booleans
- [ ] Ability activation policy and prediction were chosen deliberately
...
- `/ue-networking-replication` — verify ability replication and prediction
- `/balance-check` — sanity-check the tuning values
