...
description: "PCG framework, ProceduralMesh, instanced mesh, runtime generation, noise"
category: "gamedev"
argument-hint: "[generator o PCG graph]"
user-invocable: true
...
Ask before writing: this skill edits PCG graphs and procedural generation code. Propose the change and get approval before using Write or Edit.

## Context Check

Before advising, read `docs/unreal/project-context.md` to determine:
...
- [ ] Generation is deterministic from a seed and reproducible
- [ ] Instanced meshes are used for repeated geometry rather than individual actors
- [ ] Runtime generation is budgeted and spread across frames
...
- `/ue-world-level-streaming` — integrate generated content with streaming
